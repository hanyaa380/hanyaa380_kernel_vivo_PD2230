...
enum vts_init_flags {
	...
	OVT_MODULE =BIT(19),
	CHIPONE_NC9916 = BIT(20),
	FT3519T_I2C_MODULE = BIT(21),
	FT3519T_SPI_MODULE = BIT(22)
};
...
static int __init vts_core_init(void)
{
	...
	vts_module_init(ovt_td4375, OVT_MODULE);
	vts_module_init(chipone_nl9916, CHIPONE_NC9916);
	vts_module_init(ft3519t_i2c, FT3519T_I2C_MODULE);
	vts_module_init(ft3519t_spi, FT3519T_SPI_MODULE);	
	return 0;
}
...
static void __exit vts_core_exit(void)
{
	...
	vts_module_exit(ovt_td4375, OVT_MODULE);
	vts_module_exit(chipone_nl9916, CHIPONE_NC9916);
	vts_module_exit(ft3519t_spi, FT3519T_SPI_MODULE);
	vts_module_exit(ft3519t_i2c, FT3519T_I2C_MODULE);
}
