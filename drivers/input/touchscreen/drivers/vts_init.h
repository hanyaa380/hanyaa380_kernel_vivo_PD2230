...
int vts_driver_ovt_td4375_init(int *load);
int vts_driver_chipone_nl9916_init(int *load);
int vts_driver_ft3519t_i2c_init(int *load);
int vts_driver_ft3519t_spi_init(int *load);
...
void vts_driver_ovt_td4375_exit(void);
void vts_driver_chipone_nl9916_exit(void);
void vts_driver_ft3519t_i2c_exit(void);
void vts_driver_ft3519t_spi_exit(void);
