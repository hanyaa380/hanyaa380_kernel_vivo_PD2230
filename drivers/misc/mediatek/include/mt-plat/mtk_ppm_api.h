...
extern void mt_ppm_thermal_set_freq_limit(unsigned int cluster, int min_freq_idx, int max_freq_idx);
extern void mt_ppm_thermal_set_core_limit(unsigned int cluster, int min_core, int max_core);
