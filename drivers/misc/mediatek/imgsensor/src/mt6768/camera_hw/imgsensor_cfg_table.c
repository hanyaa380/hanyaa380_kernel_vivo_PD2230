...
#elif defined(CONFIG_MTK_CAM_PD2281F_EX)
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
...
#if defined(S5KJN1SQ03PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 3},
...
#endif
#if defined(S5KJN1SQ03V1PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03V1PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 3},
...
#endif
#if defined(S5KJN1SQ03V2PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03V2PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 3},
...
#endif
#if defined(S5KJN1SQ03V3PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03V3PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 3},
...
#endif
#if defined(S5KJN1SQ03V4PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1SQ03V4PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 3},
...
#endif
#if defined(IMX355PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_IMX355PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
...
#endif
#if defined(S5K4H7PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(GC02M1PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(GC02M1V1PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1V1PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(OV02B10PD2226F_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10PD2226F_MIPI_RAW,
		{
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 2},
			{AVDD, Vol_2800, 5},
...
#if defined(S5KJNSSQ33PD2281F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJNSSQ33PD2281F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 5},
...
#endif
#if defined(S5KJNSSQ33V1PD2281F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJNSSQ33V1PD2281F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 5},
...
#endif
#if defined(IMX355PD2281F_MIPI_RAW)
	{
		SENSOR_DRVNAME_IMX355PD2281F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 5},
...
#endif
#if defined(S5K4H7PD2281F_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7PD2281F_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC02M1BPD2281F_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1BPD2281F_MIPI_MONO,
		{
			{RST, Vol_Low, 2},
			{DOVDD, Vol_1800, 5},
			{AVDD, Vol_2800, 1},
