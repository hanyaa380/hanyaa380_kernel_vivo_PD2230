 ...
 * Filename:
 * ---------
 *	 s5kjn1sqpd2250fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kjn1sqpd2250fmipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQPD2250F_SENSOR_ID,
...
extern otp_error_code_t S5KJN1SQPD2250F_OTP_ERROR_CODE;
#endif
MUINT32  sn_inf_main_s5kjn1sqpd2250f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kjn1sqpd2250f[4];
MUINT32  af_calib_inf_main_s5kjn1sqpd2250f[6];
MUINT32  crosstalk_data_s5kjn1sqpd2250f[8006];  /*0 flag   1-836 data*/
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kjn1sqpd2250f temperature
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KJN1SQPD2250F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kjn1sqpd2250f, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_main_s5kjn1sqpd2250f, sizeof(MUINT32)*4);
				memcpy( feature_data+12, af_calib_inf_main_s5kjn1sqpd2250f, sizeof(MUINT32)*6);
			#if 0
				for (i = 0 ; i<12 ; i++ ){
					printk("sn_inf_main_s5kjn1sqpd2250f[%d]= 0x%x\n", i, sn_inf_main_s5kjn1sqpd2250f[i]);
				}
			#endif
			}
				break;
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/* get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			data[1] = 0x1F;
			for(i = 0; i< 8006 ; i++)
				data[2 + i] = crosstalk_data_s5kjn1sqpd2250f[i];
...
UINT32 S5KJN1SQPD2250F_MIPI_RAW_SensorInit(
