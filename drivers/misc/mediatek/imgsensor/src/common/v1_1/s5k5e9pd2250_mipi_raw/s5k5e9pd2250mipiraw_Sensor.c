...
#define PFX "s5k5e9pd2250_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K5E9PD2250_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =
{
	...
	{ 2560, 1920,   0, 480,   2560, 1440,    2560, 1440,   0, 0, 2560, 1440,   0, 0, 2560, 1440}, // video
	...
	{ 2560, 1920,   0,   0,   1280,  960,    1280,  960,   0, 0, 1280,  960,   0, 0, 1280,  960}, // custom1
	...
	{ 2560, 1920,   0,   0,   2560, 1920,    2560, 1920,   0, 0, 2560, 1920,   0, 0, 2560, 1920}, // custom4
...
extern int S5K5E9PD2250_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k5e9pd2250;
extern otp_error_code_t S5K5E9PD2250_OTP_ERROR_CODE;
#endif
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k5e9pd2250[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k5e9pd2250[4];  /*0 flag   1-12 data*/
	...
	do {
		*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
		...
		if (*sensor_id == imgsensor_info.sensor_id) {
			pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k5e9pd2250);
			sensor_init();
			vivo_sub_otp_read_when_power_on_s5k5e9pd2250=S5K5E9PD2250_otp_read();
			pr_info("add:end read eeprom - when_power_on = %d\n",vivo_sub_otp_read_when_power_on_s5k5e9pd2250);
			pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_sub_otp_read_when_power_on_s5k5e9pd2250, S5K5E9PD2250_OTP_ERROR_CODE);
			//vivo hope add end
		...
		case SENSOR_FEATURE_GET_CUSTOM_INFO:
			...
			switch (*feature_data) {
				case 0:	//info type: otp state
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K5E9PD2250_OTP_ERROR_CODE;//otp_state
					memcpy(feature_data+2, sn_inf_sub_s5k5e9pd2250, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_sub_s5k5e9pd2250, sizeof(MUINT32)*4); 
					break;
			}
			break;
...
UINT32 S5K5E9PD2250_MIPI_RAW_SensorInit(
