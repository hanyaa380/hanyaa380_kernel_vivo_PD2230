...
#define PFX "GC02M12250_camera_sensor"
#define LOG_1 LOG_INF("GC02M12250,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
extern otp_error_code_t GC02M1PD2250_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_gc02m1pd2250[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2250[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2250_SENSOR_ID,
		...
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1PD2250_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main2_gc02m1pd2250, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_main2_gc02m1pd2250, sizeof(MUINT32)*4);
				}
				break;
			}
		break;
...
UINT32 GC02M1PD2250_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
