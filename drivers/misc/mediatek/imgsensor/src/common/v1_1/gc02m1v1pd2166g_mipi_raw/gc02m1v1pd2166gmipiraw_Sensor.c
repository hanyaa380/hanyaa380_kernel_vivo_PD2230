...
#define PFX "GC02M1V1BV1_camera_sensor"
#define LOG_1 LOG_INF("GC02M1V1BV1,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
extern int MAIN2_2e2_otp_read(void);
extern otp_error_code_t GC02M1V1PD2166G_OTP_ERROR_CODE;
extern bool gc02m1v1pd2166g_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
#endif
MUINT32  sn_inf_main2_gc02m1v1pd2166g[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1v1pd2166g[4];
/*hope add otp check end*/

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1V1BV1_SENSOR_ID, */
	.sensor_id = GC02M1V1PD2166G_SENSOR_ID,
...
static void set_shutter(kal_uint16 shutter)
{
	...
	/* ESD recovery  */
	write_cmos_sensor(0xfe, 0x00);
	if ((read_cmos_sensor(0xd0) != 0xbe) || (read_cmos_sensor(0xd1) != 0x60) || (read_cmos_sensor(0xd2) != 0x40) || (read_cmos_sensor(0xce) != 0x6f))
	{
		write_cmos_sensor(0xfe, 0x00);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 1x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 1.185x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 1.4x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 1.659x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 2.0x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 2.37x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 2.8x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 3.318x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 4.0x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 4.74x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 5.6x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 6.636x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 8.0x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 9.48x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1V1BV1MIPI analogic gain 11.2x, GC02M1V1BV1MIPI add pregain = %d\n",
		     temp);
	}
	else {
		write_cmos_sensor(0xfe, 0x00);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	unsigned char AWB_flag_gc02m1v1pd2166g = 0;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#if 1
			gc02m1v1pd2166g_vivo_read_eeprom(0x15,&AWB_flag_gc02m1v1pd2166g);
			LOG_INF("AWB_flag: 0x%x\n",AWB_flag_gc02m1v1pd2166g);
			if((unsigned int)AWB_flag_gc02m1v1pd2166g == 0x01){
				if (*sensor_id == imgsensor_info.sensor_id) {
					...
					vivo_otp_read_when_power_on = MAIN2_2e2_otp_read();
					pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN2_2E2_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, GC02M1V1PD2166G_OTP_ERROR_CODE);
					/*vivo yy add end*/
					return ERROR_NONE;
				}
			}else{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1V1PD2166G_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_gc02m1v1pd2166g, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_gc02m1v1pd2166g, sizeof(MUINT32)*4); 
				#if 0
						for (int i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_gc02m1v1pd2166g[%d]= 0x%x\n", i, sn_inf_main2_gc02m1v1pd2166g[i]);
						}
				#endif
			}
				break;
...
UINT32 GC02M1V1PD2166G_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    GC02M1V1BV1_MIPI_RAW_SensorInit    */
