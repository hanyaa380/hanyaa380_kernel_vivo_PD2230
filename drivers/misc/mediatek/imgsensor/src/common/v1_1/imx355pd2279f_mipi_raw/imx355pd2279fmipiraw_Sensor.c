...
#include "imx355pd2279fmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "IMX355PD2279F_camera_sensor"
#define LOG_1 LOG_INF("IMX355PD2279F,MIPI 4LANE\n")
/************************   Modify end    *************************************/
...
extern int imx355pd2279f_otp_read(void);
extern otp_error_code_t IMX355PD2279F_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx355pd2279f[13];
MUINT32  material_inf_sub_imx355pd2279f[4];
MUINT32  module_inf_sub_imx355pd2279f[2];

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355PD2279F_SENSOR_ID,
	.checksum_value = 0xD1EFF68B,
	.hs_trail = 0x3C,
	.pre = {
		.pclk = 159900000,				//record different mode's pclk
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX355PD2279FMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355pd2279fMIPI_sensorGainMapping[iI][0])
			return imx355pd2279fMIPI_sensorGainMapping[iI][1];
	}

	return imx355pd2279fMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx355pd2279f_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx355pd2279f[] = {
	0x4348, 0x16,
	0x4350, 0x19,
	0x4408, 0x0A,
	0x440C, 0x0B,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_full_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x1840@30fps*/
kal_uint16 addr_data_pair_crop_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_bining_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_slim_video_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_hs_video_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom1_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_custom2_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom3_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_custom4_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom5_size_imx355pd2279f[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_init_imx355pd2279f,
		sizeof(addr_data_pair_init_imx355pd2279f)/sizeof(kal_uint16));
}


static void full_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_full_size_imx355pd2279f,
	sizeof(addr_data_pair_full_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void crop_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_crop_size_imx355pd2279f,
	sizeof(addr_data_pair_crop_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void binning_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_bining_size_imx355pd2279f,
	sizeof(addr_data_pair_bining_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void slim_video_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_slim_video_size_imx355pd2279f,
	sizeof(addr_data_pair_slim_video_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void hs_video_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_hs_video_size_imx355pd2279f,
	sizeof(addr_data_pair_hs_video_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void custom1_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_custom1_size_imx355pd2279f,
	sizeof(addr_data_pair_custom1_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void custom2_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_custom2_size_imx355pd2279f,
	sizeof(addr_data_pair_custom2_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void custom3_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_custom3_size_imx355pd2279f,
	sizeof(addr_data_pair_custom3_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void custom4_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_custom4_size_imx355pd2279f,
	sizeof(addr_data_pair_custom4_size_imx355pd2279f) / sizeof(kal_uint16));
}

static void custom5_size_setting(void)
{
	imx355pd2279f_table_write_cmos_sensor(addr_data_pair_custom5_size_imx355pd2279f,
	sizeof(addr_data_pair_custom5_size_imx355pd2279f) / sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x0A0A) << 4) |read_cmos_sensor(0x0A0B) >> 4);
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = imx355pd2279f_otp_read();
...
static kal_uint32 open(void)
{
	...
	kal_uint8 retry = 2;
	LOG_1;
	LOG_INF("imx355pd2279f open begin..\n");
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	KD_SENSOR_PROFILE("imx355pd2279f get sensor id time");
	/* initail sequence write in  */
	global_setting();
	KD_SENSOR_PROFILE("imx355pd2279f set global setting time");
	...
	spin_unlock(&imgsensor_drv_lock);
	LOG_INF("imx355pd2279f open end..\n");
	return ERROR_NONE;
} /* open */
...
{
	LOG_INF("imx355pd2279f close begin..\n");
	write_cmos_sensor(0x0100, 0x00);
	return ERROR_NONE;
}
...
{
	LOG_INF("imx355pd2279f preview begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE("imx355pd2279f set binning size setting time");
	return ERROR_NONE;
}
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("imx355pd2279f preview capture..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE_INIT();
	full_size_setting();
	KD_SENSOR_PROFILE("imx355pd2279f set full size setting time");
...
static kal_uint32 normal_video(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("imx355pd2279f normal_video begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE_INIT();
	crop_size_setting();
	KD_SENSOR_PROFILE("imx355pd2279f set crop size setting time");
...
static kal_uint32 imx355pd2279f_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
 ...
 */
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355pd2279f_awb_gain(pSetSensorAWB);
		break;
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO: {
		LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  IMX355PD2279F_OTP_ERROR_CODE:%d \n", *feature_data, IMX355PD2279F_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX355PD2279F_OTP_ERROR_CODE;
				memcpy(feature_data+2, sn_inf_sub_imx355pd2279f, sizeof(MUINT32)*13);
				memcpy(feature_data+10, material_inf_sub_imx355pd2279f, sizeof(MUINT32)*4);
				memcpy( feature_data+15, module_inf_sub_imx355pd2279f, sizeof(MUINT32)*2);
			}
			break;
		}
		break;
...
UINT32 IMX355PD2279F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
