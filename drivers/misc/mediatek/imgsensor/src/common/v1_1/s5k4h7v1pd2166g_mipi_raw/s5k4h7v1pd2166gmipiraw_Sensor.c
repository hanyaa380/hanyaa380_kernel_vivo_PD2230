 ...
 * Filename:
 * ---------
 *	 s5k4h7v1pd2166gmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "S5K4H7V1PD2166G_camera_sensor"
...
#include "s5k4h7v1pd2166gmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7V1PD2166G_SENSOR_ID,
...
extern int S5K4H7V1PD2166G_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k4h7v1pd2166g;
extern otp_error_code_t S5K4H7V1PD2166G_OTP_ERROR_CODE;
extern bool s5k4h7v1pd2166g_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
#endif
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k4h7v1pd2166g[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k4h7v1pd2166g[4];  /*0 flag   1-12 data*/
...
kal_uint16 addr_data_pair_init_s5k4h7v1pd2166g[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7v1pd2166g[] = {
0x0136, 0x18,
0x0137, 0x00,
0x0305, 0x06,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_init_s5k4h7v1pd2166g) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_preview_s5k4h7v1pd2166g) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_capture_s5k4h7v1pd2166g) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_normal_video_s5k4h7v1pd2166g) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_hs_video_s5k4h7v1pd2166g) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7v1pd2166g,
                          sizeof(addr_data_pair_slim_video_s5k4h7v1pd2166g) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7v1pd2166g,
		   sizeof(addr_data_pair_custom1_s5k4h7v1pd2166g) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7v1pd2166g,
		   sizeof(addr_data_pair_custom2_s5k4h7v1pd2166g) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7v1pd2166g,
		   sizeof(addr_data_pair_custom3_s5k4h7v1pd2166g) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7v1pd2166g,
		   sizeof(addr_data_pair_custom4_s5k4h7v1pd2166g) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7v1pd2166g,
		   sizeof(addr_data_pair_custom5_s5k4h7v1pd2166g) / sizeof(kal_uint16));
	pr_debug("end \n");
}
/*************************************************************************
 * FUNCTION
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
  kal_uint8 i = 0, j = 0;
  kal_uint8 retry = 2;
   unsigned char material_inf_s5k4h7v1pd2166g[4] ={0,0,0,0};
  int offset = 0x000F;
  ...
  while (imgsensor_info.i2c_addr_table[i] != 0xff) {
    ...
    do {
      *sensor_id = (((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001))+2);
	  ...
	  for(j = 0;j < 4;j++)
		{
			s5k4h7v1pd2166g_vivo_read_eeprom(offset,&material_inf_s5k4h7v1pd2166g[j]);
			PK_DBG("vivo_material_inf_s5k4h7v1pd2166g[%d]=0x%x",j,material_inf_s5k4h7v1pd2166g[j] );
			offset++;
		} 
		PK_DBG("i2c write id: 0x%x, sensor id: 0x%x material_inf_s5k4h7v1pd2166g=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_s5k4h7v1pd2166g[0]<<24|(unsigned int)material_inf_s5k4h7v1pd2166g[1]<<16|(unsigned int)material_inf_s5k4h7v1pd2166g[2]<<8|(unsigned int)material_inf_s5k4h7v1pd2166g[3]));  
      //*sensor_id = imgsensor_info.sensor_id;
	  if((unsigned int)material_inf_s5k4h7v1pd2166g[3] == 0x35){
 ...
 //        if(0 == ctidFlag){
        ...
        pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7v1pd2166g);
        sensor_init();
        vivo_sub_otp_read_when_power_on_s5k4h7v1pd2166g=S5K4H7V1PD2166G_otp_read();
        pr_info("add:end read eeprom - when_power_on = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7v1pd2166g);
        pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_sub_otp_read_when_power_on_s5k4h7v1pd2166g, S5K4H7V1PD2166G_OTP_ERROR_CODE);
		//vivo hope add end
        pr_info("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
        return ERROR_NONE;
			} 
         ...
         *	pr_debug(
         *	"sp8Flag(0x%x),0x5003 used by s5k4h7v1pd2166g\n", sp8spFlag);
         *
         *	if (sp8spFlag == 0x5003) {
         *		pr_debug("it is s5k4h7v1pd2166g\n");
         *		return ERROR_NONE;
         *	}
         *
         *		pr_debug(
         ...
         *	return ERROR_SENSOR_CONNECT_FAIL;
         */
     		pr_err("material_inf_s5k4h7v1pd2166g[3]=0x%x != 0x35",material_inf_s5k4h7v1pd2166g[3] );
                                *sensor_id = 0xFFFFFFFF;
                                return ERROR_SENSOR_CONNECT_FAIL;
				}
	#else
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		case 0:    //info type: otp state
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K4H7V1PD2166G_OTP_ERROR_CODE;//otp_state
			memcpy(feature_data+2, sn_inf_sub_s5k4h7v1pd2166g, sizeof(MUINT32)*13);
			memcpy( feature_data+10, material_inf_sub_s5k4h7v1pd2166g, sizeof(MUINT32)*4); 
			break;
		}
		break;
#endif
...
UINT32 S5K4H7V1PD2166G_MIPI_RAW_SensorInit(
