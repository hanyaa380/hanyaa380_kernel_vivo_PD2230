...
extern otp_error_code_t GC02M1PD2257F_OTP_ERROR_CODE;
unsigned char  sn_inf_main2_gc02m1pd2257f[13];  /*0 flag   1-12 data*/
unsigned char  module_inf_main2_gc02m1pd2257f[13];
/*hope add otp check end*/

static DEFINE_SPINLOCK(imgsensor_drv_lock);

struct IMGSENSOR_SENSOR_TABLEINFO gc02m1pd2257f_otpinfo={
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2257F_SENSOR_ID,
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		switch (*feature_data) {
			case 0:    //info type: otp state
				memcpy((MUINT8 *)feature_data,(MUINT8 *)&gc02m1pd2257f_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
				break;
			default:
...
{
	sprintf(gc02m1pd2257f_otpinfo.SN_inf,"%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X",
		sn_inf_main2_gc02m1pd2257f[1],
		sn_inf_main2_gc02m1pd2257f[2],
		sn_inf_main2_gc02m1pd2257f[3],
		sn_inf_main2_gc02m1pd2257f[4],
		sn_inf_main2_gc02m1pd2257f[5],
		sn_inf_main2_gc02m1pd2257f[6],
		sn_inf_main2_gc02m1pd2257f[7],
		sn_inf_main2_gc02m1pd2257f[8],
		sn_inf_main2_gc02m1pd2257f[9],
		sn_inf_main2_gc02m1pd2257f[10],
		sn_inf_main2_gc02m1pd2257f[11],
		sn_inf_main2_gc02m1pd2257f[12]
	);
	strcpy(gc02m1pd2257f_otpinfo.ModuleId_inf, module_inf_main2_gc02m1pd2257f);
	return 0;
}

static MUINT32 gc02m1pd2257fGetOtpInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p)
{
	if(p != NULL){
		*p = &gc02m1pd2257f_otpinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.SensorGetOtpInfo = gc02m1pd2257fGetOtpInfo
};


UINT32 GC02M1PD2257F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
