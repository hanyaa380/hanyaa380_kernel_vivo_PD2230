 ...
 * Filename:
 * ---------
 *	 s5kgw3sp13pd2257fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgw3sp13pd2257fmipiraw_freq.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5kgw3sp13pd2257f_otpinfo={
	.OTP_slave_addr = 0xA4,
	.OTP_size = 0x8000,
	...
	/* otp partition table */
	.ModuleInfo_addr = 0x5000,
	.PLATFORM_id_addr = 0x5002,
	.LENS_id_addr = 0x5008,
	.VCM_id_addr = 0x5009,
	.DRIVERIC_id_addr = 0x500A,
	.CalibrationVersion_addr = 0x500B,
	.Material_inf_addr = 0x500F,
	.ModuleInfo_checksum_addr = 0x501f,
	.Fuse_id_addr = 0x5020,
	.Fuse_id_checksum_addr = 0x5044,
	.SN_addr = 0x5045,
	.SN_checksum_addr = 0x5065,

	.Af_addr = 0x5066,
	.Af_checksum_addr = 0x508B,
	.Awb_addr = 0x508C,
	.Awb_checksum_addr = 0x50C1,
	.Lsc_addr = 0x50C2,
	.Lsc_checksum_addr = 0x581F,
	.PDAF_proc1_addr = 0x5820,
	.PDAF_proc1_checksum_addr = 0x5A20,
	.PDAF_proc2_addr = 0x5A21,
	.PDAF_proc2_checksum_addr = 0x5E18,
};

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW3SP13PD2257F_SENSOR_ID,
...
extern int MAIN_7309_otp_read_gw3_pd2257f(void);
extern otp_error_code_t S5KGW3SP13PD2257F_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgw3sp13pd2257f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgw3sp13pd2257f[4];
MUINT32  module_inf_main_s5kgw3sp13pd2257f[2];
MUINT32  af_calib_inf_main_s5kgw3sp13pd2257f[6];
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_16_16(0x602A,0x71C2);
	write_cmos_sensor_16_16(0x6F12,0x0001);
	write_cmos_sensor_16_16(0x602A,0x7082);
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000) ;
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN_7309_otp_read_gw3_pd2257f();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_S5KGW3_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KGW3SP13PD2257F_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kgw3sp13pd2257f temperature 
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		memcpy((MUINT8 *)feature_data,(MUINT8 *)&s5kgw3sp13pd2257f_otpinfo,sizeof(struct IMGSENSOR_SENSOR_TABLEINFO));
		break;
...
static MUINT32 s5kgw3sp13pd2257fGetOtpInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p)
{
	if(p != NULL){
		*p = &s5kgw3sp13pd2257f_otpinfo;
	}
	return ERROR_NONE;
}
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.SensorGetOtpInfo = s5kgw3sp13pd2257fGetOtpInfo
};

UINT32 S5KGW3SP13PD2257F_MIPI_RAW_SensorInit(
