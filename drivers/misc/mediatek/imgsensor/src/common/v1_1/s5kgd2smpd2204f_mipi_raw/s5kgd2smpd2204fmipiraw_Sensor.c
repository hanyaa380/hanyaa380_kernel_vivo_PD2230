 ...
 * Filename:
 * ---------
 *	 s5kgd2smpd2204fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgd2smpd2204fmipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGD2SMPD2204F_SENSOR_ID,
		.checksum_value = 0xffb1ec31,

	.pre = {  /* 4:3 3104x2328 30.03fps 866.67 Mbps/lane */
		.pclk = 1555050000,
		.linelength = 18000,
		.framelength = 2878,
		.startx =0,
		.starty = 0,
		.grabwindow_width = 3104,
		.grabwindow_height = 2328,
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 346668000,
		.max_framerate = 300,
	},
	.cap = {  /* 4:3 4:3 3104x2328 30.03fps 866.67 Mbps/lane same as pre */
		.pclk = 1555050000,
		.linelength = 18000,
		.framelength = 2878,
		.startx =0,
	...
	.normal_video = {	/*16:9 3104x1746 30.05fps 1516.67Mbps/lane*/
		.pclk = 802290000,
		.linelength = 6648,
		.framelength = 3988,
		.startx =0,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 606668000,
		.max_framerate = 300,
	},
	.hs_video = { /*not usehs_video 3104x2328 30.03fps 866.67 Mbps/lane same as pre */
		.pclk = 1555050000,
		.linelength = 18000,
		.framelength = 2878,
		.startx =0,
	...
	.slim_video = { /* not use slim_video 3104x2328 30.03fps 866.67 Mbps/lane same as pre*/
		.pclk = 1555050000,
		.linelength = 18000,
		.framelength = 2878,
		.startx =0,
	...
	.custom1 = {		/*16:9 3104x1746 30.05fps 1516.67Mbps/lane */
		.pclk = 802290000,
		.linelength = 6648,
		.framelength = 3988,
		.startx =0,
	...
	.custom2 = { /*16:9 3104x1746 60.08fps 1516.67Mbps/lane */
		.pclk = 802290000,
		.linelength = 6648,
		.framelength = 1994,
		.startx =0,
    ...
    .custom3 = {  /* 3104x2328 30.03fps 866.67 Mbps/lane */
		.pclk = 1555050000,
		.linelength = 18000,
		.framelength = 2878,
		.startx =0,
	...
	.custom4 = {  /* 1552x1164 30.22fps 433.33Mbps/lane*/
		.pclk = 1594666667,
		.linelength = 18000,
		.framelength = 2932,
		.startx =0,
		.starty = 0,
		.grabwindow_width = 1552,
		.grabwindow_height = 1164,
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 173332000,
		.max_framerate = 300,
	},
	.custom5 = {  /*remosaic 6528x4896 15.07fps 1516.67Mbps/lane*/
		.pclk = 1574860000,
		.linelength = 20880,
		.framelength = 5006,
		.startx =0,
		.starty = 0,
		.grabwindow_width = 6208,
		.grabwindow_height = 4656,
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 606668000,
		.max_framerate = 150,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{ 6208, 4656,	0,	0,	6208, 4656, 3104, 2328,	0000, 0000,	3104, 2328,	  0, 	0, 	3104, 2328}, /*Preview*/
	{ 6208, 4656,	0,	0,	6208, 4656, 3104, 2328,	0000, 0000,	3104, 2328,	  0, 	0, 	3104, 2328}, //capture
	{ 6208, 4656,	0,584,	6208, 3488, 3104, 1744,	0000, 0000,	3104, 1744,	  0, 	0, 	3104, 1744}, /*video*/
	{ 6208, 4656,	0,	0,	6208, 4656, 3104, 2328,	0000, 0000,	3104, 2328,	  0, 	0, 	3104, 2328}, /*hight speed video 120fps*/
	{ 6208, 4656,	0,	0,	6208, 4656, 3104, 2328,	0000, 0000,	3104, 2328,	  0, 	0, 	3104, 2328}, /*slim video  hs_video 240fps*/
	{ 6208, 4656,	0,584,	6208, 3488, 3104, 1744,	0000, 0000,	3104, 1744,	  0, 	0, 	3104, 1744}, /* custom1*/
	{ 6208, 4656,	0,584,	6208, 3488, 3104, 1744,	0000, 0000,	3104, 1744,	  0, 	0, 	3104, 1744}, /* custom2*/
	{ 6208, 4656,	0,	0,	6208, 4656, 3104, 2328,	0000, 0000,	3104, 2328,	  0, 	0, 	3104, 2328}, /* custom3*/
	{ 6208, 4656,	0,	0,	6208, 4656, 1552, 1164,	0000, 0000,	1552, 1164,	  0, 	0, 	1552, 1164}, /*custom4*/
	{ 6208, 4656,	0,	0,	6208, 4656, 6208, 4656,	0000, 0000,	6208, 4656,	  0, 	0, 	6208, 4656}, /*custom5 hw-remosiac  remosaic*/
};
#if 1
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4PosL =
		{
			{9, 8}, {17, 8}, {11, 11}, {19, 11}, {15, 12}, {23, 12}, {13, 15}, {21, 15},
			{9, 16}, {17, 16}, {11, 19}, {19, 19}, {15, 20}, {23, 20}, {13, 23}, {21, 23},
		},
	.i4PosR =
		{
			{8, 8}, {16, 8}, {10, 11}, {18, 11}, {14, 12}, {22, 12}, {12, 15}, {20, 15},
			{8, 16}, {16, 16}, {10, 19}, {18, 19}, {14, 20}, {22, 20}, {12, 23}, {20, 23},
		},
	.i4BlockNumX = 204,
	.i4BlockNumY = 153,
	.i4LeFirst = 0,
	.i4Crop = {//3280x2464  3104x2328
			{88, 68}, {88, 68}, {88, 360}, {88, 68}, {88, 68},
			{88, 360}, {88, 360}, {88, 68}, {0, 0}, {0, 0},
		},
	.iMirrorFlip = 0,
};


static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[2] = {//INI 3280x2464
	/* Preview/Capture/hs_video/slim_video/custom3 mode setting */
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x0C20, 0x0918, 0x00, 0x00, 0x0000, 0x0000,
	 0x01, 0x2B, 0x0180, 0x0910, 0x00, 0x00, 0x0000, 0x0000}, //pd size:416x2448
	/* Video/custom1/custom2 mode setting */
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x0C20, 0x06D0, 0x00, 0x00, 0x0000, 0x0000,
	 0x01, 0x2b, 0x0180, 0x05B0, 0x00, 0x00, 0x0000, 0x0000}, //pd size:403x1728
};
#endif
#if 1
...
extern int SUB_GD2SM_otp_read(void);
extern otp_error_code_t S5KGD2SMPD2204F_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5kgd2smpd2204f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5kgd2smpd2204f[4];
MUINT32  af_calib_inf_sub_s5kgd2smpd2204f[6];
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		write_cmos_sensor_16_8(0x0100, 0x01);//write_cmos_sensor_16_8(0x0100, 0x01);
		mdelay(10);
	} else {
...
//	0x6028, 0x4000,
//	0x0D06, 0x0180,
	0x6028, 0x2000, //support temperature start
	0x602A, 0x8A10,
	0x6F12, 0x0011,
	0x602A, 0x30B8,
	0x6F12, 0xC020,
	0x602A, 0x134C,
	0x6F12, 0x0001, //support temperature end
...
static kal_uint16 addr_data_pair_custom1[] = {
	...
	0x602A, 0x134C,
	0x6F12, 0x0001, //support temperature end
	0x0816, 0x0C00, //for HS-EXIT TIME
};

/*16:9 binning mode */
static kal_uint16 addr_data_pair_custom2[] = {  /*16:9 3264x1836 30.03fps 864.5Mbps/lane*/
	0x6028, 0x2000,
	0x602A, 0x12FA,
	0x6F12, 0x1450,
	0x602A, 0x1310,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_16_16(0x0000, 0x0011);
	...
	write_cmos_sensor_16_16(0x0A02, 0xFFFF);
	mdelay(10);
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000) + 1;
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = SUB_GD2SM_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KGD2SMPD2204F_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
//	struct SENSOR_RAWINFO_STRUCT *rawinfo;//vivo yuanyuan add for rawinfo
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6423000;
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		switch (*feature_data) {
			...
			case MSDK_SCENARIO_ID_SLIM_VIDEO:
		case MSDK_SCENARIO_ID_CUSTOM3:
			imgsensor_pd_info.i4BlockNumX = 192;
			imgsensor_pd_info.i4BlockNumY = 145;
		...
		case MSDK_SCENARIO_ID_CUSTOM2:
			imgsensor_pd_info.i4BlockNumX = 192;
			imgsensor_pd_info.i4BlockNumY = 91;
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info, sizeof(struct SET_PD_BLOCK_INFO_T));
		case MSDK_SCENARIO_ID_CUSTOM4:
		case MSDK_SCENARIO_ID_CUSTOM5:
			default:
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGD2SMPD2204F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5kgd2smpd2204f, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_sub_s5kgd2smpd2204f, sizeof(MUINT32)*4);
				memcpy( feature_data+12, af_calib_inf_sub_s5kgd2smpd2204f, sizeof(MUINT32)*6);

				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5kgd2smpd2204f[%d]= 0x%x\n", i, sn_inf_sub_s5kgd2smpd2204f[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGD2SMPD2204F_MIPI_RAW_SensorInit(
