...
#include "hi1634qpd2230fmipiraw_Sensor.h"
...
#if USE_BURST_MODE
static kal_uint16 hi1634qpd2230f_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634QPD2230F_SENSOR_ID,

	.checksum_value = 0x0754a310b,
	.pre = {
		.pclk = 632640000,				//record different mode's pclk
		.linelength =  5680, 			//record different mode's linelength
		.framelength = 3711, 			//record different mode's framelength
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 338000000//845*4/10
	},
	.cap = {
		.pclk = 632640000,				//record different mode's pclk
		.linelength =  5680, 			//record different mode's linelength
	...
	.hs_video = {
		.pclk = 632640000,				//record different mode's pclk
		.linelength =  5680, 			//record different mode's linelength
		.framelength = 928, 			//record different mode's framelength
		.startx = 0,				    //record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
    ...
    .custom1 = {
		...
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,
		.mipi_pixel_rate = 338000000//848*4/10
    },
    .custom2 = {
		.pclk = 632640000,				//record different mode's pclk
		.linelength =  5680, 			//record different mode's linelength
	...
	.custom5 = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 676000000//1690*4/10
    },
	...
	*/
	...
	.isp_driving_current = ISP_DRIVING_8MA, //ISP_DRIVING_2MA,
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI1634QPD2230F;
MUINT32  sn_inf_main2_hi1634qpd2230f[13];
MUINT32  material_inf_main_hi1634qpd2230f[4];
MUINT32  module_inf_main_hi1634qpd2230f[2];
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// preview (2320 x 1740)0
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// capture (2320 x 1740)0
	{ 4672, 3520,  16, 448, 4640, 2624,  2320, 1312,  0, 0, 2320, 1312, 0, 0, 2320, 1312}, 	// video (2320 x 1312)2
	{ 4672, 3520, 416, 680, 3840, 2160,  1280,  720,  0, 0,	1280,  720, 0, 0, 1280,  720}, 	// hs video (1280 x 720)3
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// slim video (1160 x 872)4
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// custom1 (2320 x 1740)0
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// custom2 (2320 x 1740)0
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// custom3 (2320 x 1740)0
	{ 4672, 3520,  16,  20, 4640, 3480,  2320, 1740,  0, 0, 2320, 1740, 0, 0, 2320, 1740}, 	// custom4 (2320 x 1740)0
	{ 4672, 3520,  16,  20, 4640, 3480,  4640, 3480,  0, 0, 4640, 3480, 0, 0, 4640, 3480}, 	// custom5 (4640 x 3496)1
};
...
static bool skhynix_write_burst_mode(kal_uint16 setting_table[], kal_uint32 nSetSize)
{
	...
	for (set_count = 0; set_count < (total_set_count-2); set_count+=2)
	{
			if (!buf_count)
			{
				...
				buf_count++;
				//pr_debug("SKHYNIX burst addr:0x%04x", setting_table[set_count]);
			}
			...
			buf_count++;
			//pr_debug("SKHYNIX burst data:0x%04x", setting_table[set_count + 1]);
			...
			err = iBurstWriteReg_multi(Hynix_i2c_buf,
						buf_count,
						imgsensor.i2c_write_id,
						buf_count,
						imgsensor_info.i2c_speed);// i2c write fuction
			pr_debug("SKHYNIX burst result = %d", err);
			if (err)  return true;
			buf_count = 0;
	}
	...
	pr_debug("SKHYNIX burst addr : 0x%x, burst data:0x%04x", setting_table[total_set_count-2], setting_table[total_set_count-1]);
...
static kal_uint16 hi1634qpd2230f_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
//init setting start
static kal_uint16 hi1634qpd2230f_init_setting_start[] = {
	/*
...
static kal_uint16 hi1634qpd2230f_init_setting_skhynix_burst[] = {
	0x2000, 0x1001,//skhynix burst start
	0x2002, 0x0000,
	0x2006, 0x40B2,
	0x2008, 0xB038,
	0x200A, 0x8430,
	...
	0x2464, 0x05FC,
	0x2466, 0x72D8,
	0x2468, 0x278D,//skhynix burst end
};
static kal_uint16 hi1634qpd2230f_init_setting_end[] = {
	/*
	DISP_DATE = "2019-11-25 10:33:55"
	DISP_FORMAT = BAYER10_PACKED
	DISP_DATAORDER = GR_QUAD
...
static kal_uint16 hi1634qpd2230f_capture_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_preview_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_normal_video_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1312
...
static kal_uint16 hi1634qpd2230f_hs_video_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1280
	DISP_HEIGHT = 720
...
static kal_uint16 hi1634qpd2230f_slim_video_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_custom1_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_custom2_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_custom3_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_custom4_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2230f_custom5_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0008,
	0x0206, 0x02C6,
	0x020A, 0x0E7B,
...
static void sensor_init(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_init_setting_start,
		sizeof(hi1634qpd2230f_init_setting_start)/sizeof(kal_uint16));
	skhynix_write_burst_mode(hi1634qpd2230f_init_setting_skhynix_burst,
		sizeof(hi1634qpd2230f_init_setting_skhynix_burst)/sizeof(kal_uint16));
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_init_setting_end,
		sizeof(hi1634qpd2230f_init_setting_end)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_preview_setting,
		sizeof(hi1634qpd2230f_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_capture_setting,
		sizeof(hi1634qpd2230f_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_normal_video_setting,
		sizeof(hi1634qpd2230f_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_hs_video_setting,
		sizeof(hi1634qpd2230f_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_slim_video_setting,
		sizeof(hi1634qpd2230f_slim_video_setting)/sizeof(kal_uint16));
...
static void custom1_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_custom1_setting,
		sizeof(hi1634qpd2230f_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_custom2_setting,
		sizeof(hi1634qpd2230f_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_custom3_setting,
		sizeof(hi1634qpd2230f_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_custom4_setting,
		sizeof(hi1634qpd2230f_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(void)
{
	...
	hi1634qpd2230f_table_write_cmos_sensor(hi1634qpd2230f_custom5_setting,
		sizeof(hi1634qpd2230f_custom5_setting)/sizeof(kal_uint16));
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0x0714, imgsensor.i2c_write_id);
		if (timeout) {
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI1634QPD2230F;//otp_state
				memcpy( feature_data+2, sn_inf_main2_hi1634qpd2230f, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_hi1634qpd2230f, sizeof(MUINT32)*4); 
				memcpy( feature_data+15, module_inf_main_hi1634qpd2230f, sizeof(MUINT32)*2);
			#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 HI1634QPD2230F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* HI1634QPD2230F_MIPI_RAW_SensorInit */
