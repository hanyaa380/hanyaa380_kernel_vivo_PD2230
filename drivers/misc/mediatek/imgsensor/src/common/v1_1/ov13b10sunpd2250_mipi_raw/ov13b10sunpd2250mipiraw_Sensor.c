 ...
 *============================================================================
 ****************************************************************************/
#define PFX "OV13B10SUNPD2250_camera_sensor"
...
#include "ov13b10sunpd2250mipiraw_Sensor.h"
...
extern int ov13b10sunpd2250_vivo_otp_read(void);
extern otp_error_code_t OV13B10SUNPD2250_OTP_ERROR_CODE;
MUINT32  sn_inf_main_ov13b10sunpd2250[13];/* 0 flag   1-12 data */
MUINT32  material_inf_main_ov13b10sunpd2250[4];
MUINT32  af_calib_inf_main_ov13b10sunpd2250[6];
MUINT32  module_inf_main_ov13b10sunpd2250[2];

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static bool bIsLongExposure = KAL_FALSE;

//vivo lishuo add for otp remake 20210823 [B210820-3030] begin
struct IMGSENSOR_SENSOR_TABLEINFO ov13b10sunpd2250_otpinfo={
	.OTP_slave_addr = 0xA4,
	.OTP_size = 0x19DF,
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10SUNPD2250_SENSOR_ID,
...
static kal_uint16 ov13b10sunpd2250_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10sunpd2250[] = {
	0x0103, 0x01,
	0x0303, 0x02,
	0x0305, 0x56,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	mdelay(10);
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10sunpd2250,
		sizeof(addr_data_pair_init_ov13b10sunpd2250) / sizeof(kal_uint16));
	LOG_INF(PFX "MULTI_WRITE sensor_init() end\n");
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10sunpd2250[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void preview_setting(void)
{
	...
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10sunpd2250,
		sizeof(addr_data_pair_preview_ov13b10sunpd2250) / sizeof(kal_uint16));

	LOG_INF(PFX "preview_setting() end\n");
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10sunpd2250[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10sunpd2250[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10sunpd2250_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10sunpd2250,
			sizeof(addr_data_pair_capture_15fps_ov13b10sunpd2250) /
			sizeof(kal_uint16));
	} else {
		ov13b10sunpd2250_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10sunpd2250,
			sizeof(addr_data_pair_capture_30fps_ov13b10sunpd2250) /
			sizeof(kal_uint16));
	}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10sunpd2250[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10sunpd2250,
		sizeof(addr_data_pair_video_ov13b10sunpd2250) /
		sizeof(kal_uint16));
	LOG_INF(PFX "normal_video end\n");
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10sunpd2250[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10sunpd2250[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
static void hs_video_setting(void)
{
	...
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10sunpd2250,
		sizeof(addr_data_pair_hs_video_ov13b10sunpd2250) /
		sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10sunpd2250,
		sizeof(addr_data_pair_slim_video_ov13b10sunpd2250) /
		sizeof(kal_uint16));
...
#if 1
kal_uint16 addr_data_pair_custom2_ov13b10sunpd2250[] = {
	0x0305, 0x2b,
	0x0327, 0x05,
	0x3501, 0x06,
	0x3502, 0x00,
...
static void custom2_setting(kal_uint16 currefps)
{
	...
	ov13b10sunpd2250_table_write_cmos_sensor(
		addr_data_pair_custom2_ov13b10sunpd2250,
		sizeof(addr_data_pair_custom2_ov13b10sunpd2250) /
		sizeof(kal_uint16));
...
bool ov13b10sunpd2250_vivo_read_eeprom(kal_uint16 addr,  BYTE *data)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 retry = 2;
	int offset = 0x0013;
	unsigned char material_inf_ov13b10sunpd2250 = 0;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				ret = ov13b10sunpd2250_vivo_read_eeprom(offset , &material_inf_ov13b10sunpd2250);
				if (!ret)
					LOG_ERR(PFX "ov13b10sunpd2250 vivo read eeprom fail!\n");
				else
					LOG_INF(PFX "vivo_material_inf_ov13b10sunpd2250 = 0x%x\n", material_inf_ov13b10sunpd2250);
				if (material_inf_ov13b10sunpd2250 == 0x55) {
					vivo_otp_read_when_power_on = ov13b10sunpd2250_vivo_otp_read();
					LOG_INF(PFX "start read eeprom vivo_otp_read_when_power_on = %d\n", vivo_otp_read_when_power_on);
					LOG_INF(PFX "read eeprom OTP_ERROR_CODE = %d\n", OV13B10SUNPD2250_OTP_ERROR_CODE);
					return ERROR_NONE;
				}
			}
			LOG_ERR(PFX "Read sensor id fail, write id: 0x%x, id: 0x%x, material_inf: 0x%x\n", imgsensor.i2c_write_id, *sensor_id, material_inf_ov13b10sunpd2250);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		LOG_INF(PFX "SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV13B10SUNPD2250_OTP_ERROR_CODE:%d\n", *feature_data, OV13B10SUNPD2250_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    /* info type: otp state */
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV13B10SUNPD2250_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_ov13b10sunpd2250, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_main_ov13b10sunpd2250, sizeof(MUINT32)*4);
					memcpy( feature_data+12, af_calib_inf_main_ov13b10sunpd2250, sizeof(MUINT32)*6);
					memcpy( feature_data+15, module_inf_main_ov13b10sunpd2250, sizeof(MUINT32)*2);
				}
				break;
		}
		break;
...
static MUINT32 ov13b10sunpd2250GetOtpInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p)
{
	if(p != NULL){
		*p = &ov13b10sunpd2250_otpinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	control,
	close,
	.SensorGetOtpInfo = ov13b10sunpd2250GetOtpInfo //vivo lishuo add for otp remake 20210823 [B210820-3030]
};

UINT32 OV13B10SUNPD2250_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
