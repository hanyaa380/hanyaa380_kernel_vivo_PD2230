 ...
 * Filename:
 * ---------
 *	 s5kjnsv1pd2279mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "MAIN[38EF]_s5kjnsv1pd2279"
...
#include "s5kjnsv1pd2279mipiraw_freq.h"
...
extern bool s5kjnsv1pd2279_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJNSV1PD2279_SENSOR_ID,
	...
	.pre = {		//1
		...
		.mipi_pixel_rate = 676000000,//mipi
	...
	.hs_video = { /*hs_video 120fps*/	//6
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 790400000, //1848
		.max_framerate = 1200,//120.16
		},
	.slim_video = { /* hs_video 240fps*/	//7
		.pclk =596413440,
		.linelength = 2064,
		.framelength = 1204,
		.startx =0,
		...
		.grabwindow_height = 1080,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 790400000, //1612.0
		.max_framerate = 2400,//240.16
		},
	.custom1 = { /* 3264*2448@30fps */
		.pclk =560000000,
		.linelength = 4584,
		.framelength = 4064,
		.startx =0,
	...
	.custom2 = {	//4
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 707200000,/*511200000*/
		.max_framerate = 600,//60.01
	},
	.custom3 = { /* 3840*2160@30fps  */	//3
		.pclk =560332800,
		.linelength = 4096,
		.framelength = 4560,
		.startx =0,
	...
	.custom6 = { /* 3840*2160@30fps */	//3
		.pclk =560332800,	//????
		.linelength = 4096,
		.framelength = 4560,//2292
		.startx =0,
		.starty = 0,
		.grabwindow_width = 3840,
		.grabwindow_height = 2160,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060}, /*Preview*/			//1 4080*3060*30FPS
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060}, /* capture */		//1 4080*3060*30FPS
	{4080, 3072,   0, 388, 4080, 2296, 4080, 2296, 0, 0, 4080, 2296, 0, 0, 4080, 2296}, /* normal video */	//2 4080*2296*30FPS
	{4080, 3072, 120, 456, 3840, 2160, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080}, /* hs_video */		//6.1920*1080*120FPS
	{4080, 3072, 120, 456, 3840, 2160, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080}, /* slim video */	//7.1920*1080*240FPS
	{4080, 3072, 408, 312, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, /* custom1 */		//no_NEW1 3264*2448*30FPS
	{4080, 3072, 120, 456, 3840, 2160, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160}, /* custom2 */		//4.3840*2160*60FPS
	{4080, 3072, 120, 456, 3840, 2160, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160}, /* custom3 */		//3.3840*2160*30FPS
	{4080, 3072, 120, 456, 3840, 2160, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160}, /* custom4 */		//3.3840*2160*30FPS
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060},/* sw remosiac*/	//no
	{4080, 3072, 120, 456, 3840, 2160, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160}, /* custom6 */		//3.3840*2160*30FPS
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060},
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060},
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060},
	{4080, 3072,   0,   6, 4080, 3060, 4080, 3060, 0, 0, 4080, 3060, 0, 0, 4080, 3060},
};
...
{/* Preview mode setting 4080*3060*/
	...
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x0FF0, 0x08F8, 0x00, 0x00, 0x00, 0x00,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4080X3060
{
	...
	.i4BlockNumY = 382,
	.iMirrorFlip = 0,
	.i4Crop = { {0,6}, {0,6}, {0, 388}, {120, 456}, {120, 456}, {408, 312}, {120, 456}, {120, 456}, {120, 456}, {0, 6}, {120, 456}, {0, 6}, {0, 6}, {0, 6}, {0, 6}},
...
extern int s5kjnsv1pd2279_MAIN_38EF_otp_read(void);
extern otp_error_code_t S5KJNSV1PD2279_OTP_ERROR_CODE;
#endif
extern MUINT32 sn_inf_main_s5kjnsv1pd2279[13];  /*0 flag   1-12 data*/
extern MUINT32 material_inf_main_s5kjnsv1pd2279[4];
extern MUINT32 af_calib_inf_main_s5kjnsv1pd2279[6];
extern unsigned char crosstalk_data_s5kjnsv1pd2279[ FOUR_CELL_SIZE];  /*0 flag   1-836 data*/
extern MUINT32 module_inf_main_s5kjnsv1pd2279[2];
...
//addr_data_pair_preview end

//addr_data_pair_capture start
//static kal_uint16 addr_data_pair_capture[] = {

//};
//addr_data_pair_capture end

//addr_data_pair_normal_video start
...
//addr_data_pair_normal_video end

//addr_data_pair_hs_video start
...
//addr_data_pair_hs_video end

//addr_data_pair_slim_video start
...
//addr_data_pair_slim_video end

//addr_data_pair_custom1 start
static kal_uint16 addr_data_pair_custom1[] = {  //3264x2448
    0x6028, 0x2400,
    0x602A, 0x1A28,
    0x6F12, 0x4C00,
    0x602A, 0x065A,
...
//addr_data_pair_custom1 end

//addr_data_pair_custom2 start
...
//addr_data_pair_custom2 end

//addr_data_pair_custom3 start
...
//addr_data_pair_custom3 end

//addr_data_pair_custom4 start
...
//addr_data_pair_custom4 end

//addr_data_pair_custom5 start
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_16_16(0x0000,0x38EE);
	write_cmos_sensor_16_16(0x001E,0x000B);
	write_cmos_sensor_16_16(0x6028,0x4000);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		s5kjnsv1pd2279_vivo_read_eeprom(0x0001, module_id);
		PK_DBG("otp read  module_id: 0x%x\n", module_id[0]);
		if(module_id[0] != 0x01) {
			PK_DBG("otp read  module_id fail: 0x%x\n", module_id[0]);
			return ERROR_SENSOR_CONNECT_FAIL;
		}
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000) + 1;
			PK_DBG("read out sensor id 0x%x,,addr:%d \n", *sensor_id,i);
			if (( *sensor_id == imgsensor_info.sensor_id) || ( *sensor_id == 0xee39)) { //compatible jnv\jn1
				...
				vivo_otp_read_when_power_on = s5kjnsv1pd2279_MAIN_38EF_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_S5KJNSV1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KJNSV1PD2279_OTP_ERROR_CODE);
				/*vivo lxd add end*/
#endif
				return ERROR_NONE;
			}
	...
	if ((*sensor_id != imgsensor_info.sensor_id) && ( *sensor_id != 0xee39)) {
...
static kal_uint32 open(void)
{
	...
	if ((imgsensor_info.sensor_id != sensor_id) && (sensor_id != 0xee38)) //compatible jnv\jn1
		return ERROR_SENSOR_CONNECT_FAIL;
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kjnspd2279 temperature
...
//	write_cmos_sensor_16_16(0x6028, 0x4000);
	...
	TMC_Shift_Value = TMC_000A_Value >> 15;
	PK_DBG("s5kjn1sq03 TMC 0X0020 Value = 0x%4x, TMC Shift Value = 0x%4X\n", TMC_000A_Value, TMC_Shift_Value);

	if (TMC_Shift_Value == 1){
	  		PK_DBG("GW3 TMC Value is < 0 ,TMC is Disable TMC_0020_Value = 0x%x\n", TMC_000A_Value);
	}
	else{
		TMC_Value = (TMC_000A_Value & 0XFF00) / 256;
		if ((TMC_Value > 80) || (TMC_Value < 20)){
			PK_DBG("s5kjn1sq03 TMC 0X0020 temperature Value = %d, cause of TMC > 80 or TMC < 20 \n", TMC_Value);
			TMC_Value = 0;
		}
		PK_DBG("s5kjn1sq03 TMC 0x0020 register value 0x%x temperature value = %d", TMC_000A_Value, TMC_Value);
	}
	return TMC_Value;
}
#endif
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	struct SENSOR_RAWINFO_STRUCT *rawinfo;	// vivo add rawinfo
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		case MSDK_SCENARIO_ID_CUSTOM4:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1;
			break;
		case MSDK_SCENARIO_ID_CUSTOM5:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1; /* FULL */
			break;
		case MSDK_SCENARIO_ID_CUSTOM6:
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 1;/* 3840x2160 */
			break;
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN_F8D1_OTP_ERROR_CODE:%d \n", *feature_data,S5KJNSV1PD2279_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KJNSV1PD2279_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kjnsv1pd2279, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_main_s5kjnsv1pd2279, sizeof(MUINT32)*4);
				memcpy( feature_data+12, af_calib_inf_main_s5kjnsv1pd2279, sizeof(MUINT32)*6);
				memcpy( feature_data+15, module_inf_main_s5kjnsv1pd2279, sizeof(MUINT32)*2);
			#if 0
				for (i = 0 ; i<12 ; i++ ){
					PK_DBG("sn_inf_main_s5kjnsv1pd2279[%d]= 0x%x\n", i, sn_inf_main_s5kjnsv1pd2279[i]);
				}
			#endif
			}
				break;
	...
	case SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME:
		...
		break;
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kjnsv1pd2279 temperature
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/* get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			data[0] = FOUR_CELL_SIZE & 0xFF;
			data[1] = ((FOUR_CELL_SIZE >> 8) & 0xff);
			for(i = 0; i< FOUR_CELL_SIZE; i++)
				data[i+2] = crosstalk_data_s5kjnsv1pd2279[i];
...
UINT32 S5KJNSV1PD2279_MIPI_RAW_SensorInit(
