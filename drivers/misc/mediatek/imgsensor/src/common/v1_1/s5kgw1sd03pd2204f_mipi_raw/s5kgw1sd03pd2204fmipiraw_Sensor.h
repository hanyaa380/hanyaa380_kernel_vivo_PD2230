 ...
 * Filename:
 * ---------
 *	 s5kgw1sd03pd2204fmipiraw_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _S5KGW1SD03PD2204FMIPI_SENSOR_H
#define _S5KGW1SD03PD2204FMIPI_SENSOR_H
...
struct imgsensor_struct {
	...
	struct fmc_sturct
	{
		kal_bool   isLoad;
		kal_bool   isROIZoom;
		kal_uint16 blockPerFrame;
		kal_uint16 updateIdx;
		kal_uint16 liveloadTotalCount;
	} fmcSetting;
};
...
#endif
/* _S5KGW1SD03PD2204FMIPI_SENSOR_H */
