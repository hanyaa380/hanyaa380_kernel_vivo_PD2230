...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02B10PD2230_SENSOR_ID,
...
extern int MAIN2_002B_otp_read(void);
extern otp_error_code_t OV02B10PD2230_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_ov02b10pd2230[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_ov02b10pd2230[4];
MUINT32  module_inf_main2_ov02b10pd2230[2];
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN2_002B_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,SUB2_2375_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV02B10PD2230_OTP_ERROR_CODE);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OV02B10PD2230_OTP_ERROR_CODE:%d \n", *feature_data,OV02B10PD2230_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV02B10PD2230_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_ov02b10pd2230, sizeof(MUINT32)*13);
//				memcpy( feature_data+10, material_inf_main2_ov02b10pd2230, sizeof(MUINT32)*4);
				memcpy( feature_data+15, module_inf_main2_ov02b10pd2230, sizeof(MUINT32)*2);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 OV02B10PD2230_MIPI_RAW_SensorInit(
