...
extern otp_error_code_t GC02M1PD2166G_OTP_ERROR_CODE;
extern bool gc02m1pd2166g_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
#endif
MUINT32  sn_inf_main2_gc02m1pd2166g[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2166g[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2166G_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	unsigned char AWB_flag_gc02m1pd2166g = 0;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#if 1
			gc02m1pd2166g_vivo_read_eeprom(0x15,&AWB_flag_gc02m1pd2166g);
			LOG_INF("AWB_flag: 0x%x\n",AWB_flag_gc02m1pd2166g);
			if((unsigned int)AWB_flag_gc02m1pd2166g == 0x00 && (lcm_id == '0' || lcm_id == '1')){
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1PD2166G_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_gc02m1pd2166g, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_gc02m1pd2166g, sizeof(MUINT32)*4); 
				#if 0
						for (int i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_gc02m1pd2166g[%d]= 0x%x\n", i, sn_inf_main2_gc02m1pd2166g[i]);
						}
				#endif
			}
				break;
...
UINT32 GC02M1PD2166G_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
