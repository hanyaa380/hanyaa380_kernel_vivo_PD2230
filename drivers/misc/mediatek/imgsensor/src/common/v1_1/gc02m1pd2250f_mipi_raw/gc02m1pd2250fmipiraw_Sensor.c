...
#define PFX "GC02M12250F_camera_sensor"
#define LOG_1 LOG_INF("GC02M12250F,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
extern otp_error_code_t GC02M1PD2250F_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_gc02m1pd2250f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2250f[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2250F_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x01, 0x6b);//0b
	...
	write_cmos_sensor(0xde, 0x1c);//1d
		...
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1PD2250F_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main2_gc02m1pd2250f, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_main2_gc02m1pd2250f, sizeof(MUINT32)*4);
				}
				break;
			}
		break;
...
UINT32 GC02M1PD2250F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
