...
#if USE_BURST_MODE
static kal_uint16 hi1634qpd2250f_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634QPD2250F_SENSOR_ID,
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI1634QPD2250F;
MUINT32  sn_inf_main2_hi1634qpd2250f[13];
MUINT32  material_inf_main_hi1634qpd2250f[4];
...
static kal_uint16 hi1634qpd2250f_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 hi1634qpd2250f_init_setting[] = {
	/*
...
static kal_uint16 hi1634qpd2250f_capture_setting[] = {
	0x0B00, 0x0000,
	0x0204, 0x0008,
	0x0206, 0x02C6,
	0x020A, 0x0E7B,
...
static kal_uint16 hi1634qpd2250f_preview_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2250f_normal_video_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1312
...
static kal_uint16 hi1634qpd2250f_hs_video_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1280
	DISP_HEIGHT = 720
...
static kal_uint16 hi1634qpd2250f_slim_video_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1160
	DISP_HEIGHT = 872
...
static kal_uint16 hi1634qpd2250f_custom1_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1160
	DISP_HEIGHT = 872
...
static kal_uint16 hi1634qpd2250f_custom2_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1160
	DISP_HEIGHT = 872
...
static kal_uint16 hi1634qpd2250f_custom3_setting[] = {
	/*
	[SENSOR_RES_MOD]
	DISP_WIDTH = 1160
	DISP_HEIGHT = 872
...
static kal_uint16 hi1634qpd2250f_custom4_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634qpd2250f_custom5_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static void sensor_init(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_init_setting,
		sizeof(hi1634qpd2250f_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_preview_setting,
		sizeof(hi1634qpd2250f_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_capture_setting,
		sizeof(hi1634qpd2250f_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_normal_video_setting,
		sizeof(hi1634qpd2250f_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_hs_video_setting,
		sizeof(hi1634qpd2250f_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_slim_video_setting,
		sizeof(hi1634qpd2250f_slim_video_setting)/sizeof(kal_uint16));
...
static void custom1_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_custom1_setting,
		sizeof(hi1634qpd2250f_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_custom2_setting,
		sizeof(hi1634qpd2250f_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_custom3_setting,
		sizeof(hi1634qpd2250f_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_custom4_setting,
		sizeof(hi1634qpd2250f_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(void)
{
	...
	hi1634qpd2250f_table_write_cmos_sensor(hi1634qpd2250f_custom5_setting,
		sizeof(hi1634qpd2250f_custom5_setting)/sizeof(kal_uint16));
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI1634QPD2250F;//otp_state
				memcpy( feature_data+2, sn_inf_main2_hi1634qpd2250f, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_hi1634qpd2250f, sizeof(MUINT32)*4); 
			#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 HI1634QPD2250F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* HI1634QPD2250F_MIPI_RAW_SensorInit */
