...
extern int MAIN2_gc02m1_otp_read(void);
extern char *get_board_version(void);
extern otp_error_code_t GC02M1BPD2279HF_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_gc02m1bpd2279hf[13];  /*0 flag   1-12 data*/
MUINT32 fpc_main2_gc02m1bpd2279hf[4];
MUINT32  material_inf_main2_gc02m1bpd2279hf[4];
MUINT32  module_inf_main2_gc02m1bpd2279hf[2];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1BPD2279HF_SENSOR_ID,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id && hw_version[13] == '0') {
				...
				vivo_otp_read_when_power_on = MAIN2_gc02m1_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN2_2E0_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, GC02M1BPD2279HF_OTP_ERROR_CODE);
				/*vivo yy add end*/
				return ERROR_NONE;
			}
			LOG_INF
...
static kal_uint32 open(void)
{
	...
	if (imgsensor_info.sensor_id != sensor_id || hw_version[13] != '0')
		return ERROR_SENSOR_CONNECT_FAIL;
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32) * 23 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1BPD2279HF_OTP_ERROR_CODE;//otp_state
				memcpy(feature_data+2, sn_inf_main2_gc02m1bpd2279hf, sizeof(MUINT32) * 13);
				memcpy(feature_data+10, material_inf_main2_gc02m1bpd2279hf, sizeof(MUINT32) * 4);
				memcpy(feature_data+15, module_inf_main2_gc02m1bpd2279hf, sizeof(MUINT32) * 2);
				memcpy(feature_data + 17, fpc_main2_gc02m1bpd2279hf, sizeof(MUINT32) * 4);

				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_gc02m1bpd2279hf[%d]= 0x%x\n", i, sn_inf_main_gc02m1bpd2279hf[i]);
						}
				#endif
			}
				break;
...
UINT32 GC02M1BPD2279HF_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
