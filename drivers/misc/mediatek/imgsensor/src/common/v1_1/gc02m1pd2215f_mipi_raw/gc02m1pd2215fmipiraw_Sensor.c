...
extern otp_error_code_t GC02M1PD2215F_OTP_ERROR_CODE;
MUINT32  sn_inf_main2_gc02m1pd2215f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2215f[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1PD2215F_SENSOR_ID,
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = GC02M1PD2215F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_gc02m1pd2215f, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main2_gc02m1pd2215f, sizeof(MUINT32)*4);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_gc02m1pd2215f[%d]= 0x%x\n", i, sn_inf_main_gc02m1pd2215f[i]);
						}
				#endif
			}
				break;
...
UINT32 GC02M1PD2215F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
