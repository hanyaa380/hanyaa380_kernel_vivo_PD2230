...
#define PFX "S5K4H7PD2281F_camera_sensor"
...
#include "s5k4h7pd2281fmipiraw_Sensor.h"
...
struct IMGSENSOR_SENSOR_TABLEINFO s5k4h7pd2281f_otpinfo = {
	.OTP_slave_addr = 0xA2,
	.OTP_size = 0x0F31,
	...
	.MtkLscType = 2,
	.PixId = 2, //GR
	.TableRotation = ROTATION_HV_MIRROR,
	...
	.Awb_addr = 0x009C,
	.Awb_checksum_addr = 0x00D1,
	.Lsc_addr = 0x07D3,
	.Lsc_checksum_addr = 0x0F30
};
//vivo lishuo add for otp remake 20210823 [B210820-3030] end

static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7PD2281F_SENSOR_ID,
...
#define write_cmos_sensor(addr, para)                                          \
	iWriteRegI2C((u16)addr, (u32)para, 1, imgsensor.i2c_write_id)
#endif
...
kal_uint16 addr_data_pair_init_s5k4h7pd2281f[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7pd2281f[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7pd2281f,
                          sizeof(addr_data_pair_init_s5k4h7pd2281f) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7pd2281f,
                          sizeof(addr_data_pair_preview_s5k4h7pd2281f) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7pd2281f,
                          sizeof(addr_data_pair_capture_s5k4h7pd2281f) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7pd2281f,
                          sizeof(addr_data_pair_normal_video_s5k4h7pd2281f) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7pd2281f,
                          sizeof(addr_data_pair_hs_video_s5k4h7pd2281f) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7pd2281f,
                          sizeof(addr_data_pair_slim_video_s5k4h7pd2281f) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7pd2281f,
		   sizeof(addr_data_pair_custom1_s5k4h7pd2281f) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7pd2281f,
		   sizeof(addr_data_pair_custom2_s5k4h7pd2281f) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7pd2281f,
		   sizeof(addr_data_pair_custom3_s5k4h7pd2281f) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7pd2281f,
		   sizeof(addr_data_pair_custom4_s5k4h7pd2281f) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7pd2281f,
		   sizeof(addr_data_pair_custom5_s5k4h7pd2281f) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
 ...
 return ERROR_NONE;
         ...
         *	pr_debug(
         *	"sp8Flag(0x%x),0x5003 used by s5k4h7pd2281f\n", sp8spFlag);
         *
         *	if (sp8spFlag == 0x5003) {
         *		pr_debug("it is s5k4h7pd2281f\n");
         *		return ERROR_NONE;
         *	}
         *
         *		pr_debug(
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		case 0:    //info type: otp state
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K4H7PD2281F_OTP_ERROR_CODE;//otp_state
			memcpy(feature_data+2, sn_inf_sub_s5k4h7pd2281f, sizeof(MUINT32)*13);
			memcpy( feature_data+10, material_inf_sub_s5k4h7pd2281f, sizeof(MUINT32)*4); 
			break;
		}
#else
		switch (*feature_data) {
...
static MUINT32 s5k4h7pd2281fGetOtpInfo(struct IMGSENSOR_SENSOR_TABLEINFO **p)
{
	if (p != NULL) {
		*p = &s5k4h7pd2281f_otpinfo;
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	close,
	.SensorGetOtpInfo =
		s5k4h7pd2281fGetOtpInfo, //vivo lishuo add for otp remake 20210823 [B210820-3030]

};

UINT32 S5K4H7PD2281F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
