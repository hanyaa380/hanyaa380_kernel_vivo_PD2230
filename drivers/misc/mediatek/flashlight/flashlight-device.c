...
#elif defined(CONFIG_MTK_FLASHLIGHT_AW36518)|| defined(CONFIG_MTK_FLASHLIGHT_LM3644)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
	{0, 0, 0, "flashlights-lm3644", 0, 1},
	{0, 0, 0, "flashlights-aw36518", 0, 1},
};
#elif defined(CONFIG_MTK_CAM_PD2230) || defined(CONFIG_MTK_CAM_PD2279) || defined(CONFIG_MTK_CAM_PD2279F)
const struct flashlight_device_id flashlight_id[] = {
	/* {TYPE, CT, PART, "NAME", CHANNEL, DECOUPLE} */
