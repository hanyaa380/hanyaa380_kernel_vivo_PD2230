...
static int dw9714_init(void)
{
	...
	printk("[DW9714AF] dw9714_init - beg\n");
	puSendCmd[0] = 0xED;
	puSendCmd[1] = 0xAB;//advamce mode
	g_pstAF_I2Cclient->addr = AF_I2C_SLAVE_ADDR;
	...
	if (i4RetValue < 0)
	{
	   printk("[DW9714AF] I2C send failed!! \n");
	}
	mdelay(5);
	puSendCmd[0] = 0x06;
	...
	LOG_INF("[DW9714AF] DW9714AF SRC Init End!! \n");
...
/* ////////////////////////////////////////////////////////////// */
long DW9714VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9714VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
