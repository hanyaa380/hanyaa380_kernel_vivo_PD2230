...
#define OIS_READY_CHECK_1           0xF073
#define OIS_READY_CHECK_2           0x2045
...
#define DW9781C_PANTILT_ON          0x0000
#define DW9781C_PANTILT_OFF         0x8000
#define DW9781C_PANTILT_1DU         0x03E8


#define OIS_UINT_TO_INT(data) \
	((data <= 32767) ? data : data - 65535)
...
#define DW9781C_REG_OIS_ACC_RAWX            0x731E
#define DW9781C_REG_OIS_ACC_RAWY            0x731F
...
#define DW9781C_REG_OIS_OSC_CTL             0x703C  //0x8000 oscillation detect on, 0x8001 x axis osc, 0x8002 y axis osc, 0x8003 x&y osc
#define DW9781C_REG_OIS_OSC_XCOUNT          0x7286  // oscillation count
#define DW9781C_REG_OIS_OSC_YCOUNT          0x7287
...
#define DW9781C_REG_OIS_LOOPGAINX           0x7293  // X servo loop gain
#define DW9781C_REG_OIS_LOOPGAINY           0x72A3
...
#define DW9781C_REG_OIS_READY_CHECK_1       0x8000
#define DW9781C_REG_OIS_READY_CHECK_2       0x8001
...
#define DW9781C_REG_OIS_INIT_FW_VER         0xA7FB  // ic all protection release2
#define DW9781C_REG_OIS_GYRO_FILTERX        0x70F4
#define DW9781C_REG_OIS_GYRO_FILTERY        0x70F5
#define DW9781C_REG_OIS_ACC_FILTERX         0x7320
#define DW9781C_REG_OIS_ACC_FILTERY         0x7321
#define DW9781C_REG_OIS_GYRO_TARGETX        0x7105
#define DW9781C_REG_OIS_GYRO_TARGETY        0x7106
#define DW9781C_REG_OIS_ACC_TARGETX         0x70EC
#define DW9781C_REG_OIS_ACC_TARGETY         0x70ED
#define DW9781C_REG_OIS_TOTAL_TARGETX       0x7274
#define DW9781C_REG_OIS_TOTAL_TARGETY       0x7275
