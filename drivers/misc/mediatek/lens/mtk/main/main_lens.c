...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9714VAF, DW9714VAF_SetI2Cclient, DW9714VAF_Ioctl,
	 DW9714VAF_Release, DW9714VAF_GetFileName, NULL},
	#endif
	...
	{1, AFDRV_DW9714V2AF, DW9714V2AF_SetI2Cclient, DW9714V2AF_Ioctl,
	 DW9714V2AF_Release, DW9714V2AF_GetFileName, NULL},
	{1, AFDRV_DW9714V3AF, DW9714V3AF_SetI2Cclient, DW9714V3AF_Ioctl,
	 DW9714V3AF_Release, DW9714V3AF_GetFileName, NULL},
	{1, AFDRV_DW9714V4AF, DW9714V4AF_SetI2Cclient, DW9714V4AF_Ioctl,
	 DW9714V4AF_Release, DW9714V4AF_GetFileName, NULL},
...
//#endif
	...
	{1, AFDRV_GT9772AF, GT9772AF_SetI2Cclient, GT9772AF_Ioctl,
	 GT9772AF_Release, GT9772AF_GetFileName, NULL},
	{1, AFDRV_GT9772V2AF, GT9772V2AF_SetI2Cclient, GT9772V2AF_Ioctl,
	 GT9772V2AF_Release, NULL, NULL},
...
static void camaf_power_on(void)
{
	...
	if (vcamaf_ldo) {
#if defined(CONFIG_MTK_CAM_PD2250) || defined(CONFIG_MTK_CAM_PD2257F_EX)
...
#if defined(CONFIG_MTK_CAM_PD2215F_EX) || defined(CONFIG_MTK_CAM_PD2204F_EX) || defined(CONFIG_MTK_CAM_PD2257F_EX)|| defined(CONFIG_MTK_CAM_PD2282)
