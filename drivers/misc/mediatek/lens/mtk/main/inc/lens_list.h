...
#define DW9714VAF_PowerDown DW9714VAF_PowerDown_Main
#define DW9714VAF_GetFileName DW9714VAF_GetFileName_Main
...
extern int DW9714VAF_PowerDown(struct i2c_client *pstAF_I2Cclient, int *pAF_Opened);
extern int DW9714VAF_GetFileName(unsigned char *pFileName);

#define DW9714V2AF_SetI2Cclient DW9714V2AF_SetI2Cclient_Main
#define DW9714V2AF_Ioctl DW9714V2AF_Ioctl_Main
#define DW9714V2AF_Release DW9714V2AF_Release_Main
#define DW9714V2AF_GetFileName DW9714V2AF_GetFileName_Main
extern int DW9714V2AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714V2AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714V2AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9714V2AF_GetFileName(unsigned char *pFileName);

#define DW9714V4AF_SetI2Cclient DW9714V4AF_SetI2Cclient_Main
#define DW9714V4AF_Ioctl DW9714V4AF_Ioctl_Main
#define DW9714V4AF_Release DW9714V4AF_Release_Main
#define DW9714V4AF_GetFileName DW9714V4AF_GetFileName_Main
extern int DW9714V4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714V4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714V4AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9714V4AF_GetFileName(unsigned char *pFileName);

#define DW9714V3AF_SetI2Cclient DW9714V3AF_SetI2Cclient_Main
#define DW9714V3AF_Ioctl DW9714V3AF_Ioctl_Main
#define DW9714V3AF_Release DW9714V3AF_Release_Main
#define DW9714V3AF_GetFileName DW9714V3AF_GetFileName_Main
extern int DW9714V3AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714V3AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714V3AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9714V3AF_GetFileName(unsigned char *pFileName);
...
#define GT9772V2AF_SetI2Cclient GT9772V2AF_SetI2Cclient_Main
#define GT9772V2AF_Ioctl GT9772V2AF_Ioctl_Main
#define GT9772V2AF_Release GT9772V2AF_Release_Main
#define GT9772V2AF_GetFileName GT9772V2AF_GetFileName_Main
extern int GT9772V2AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GT9772V2AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9772V2AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int GT9772V2AF_GetFileName(unsigned char *pFileName);
