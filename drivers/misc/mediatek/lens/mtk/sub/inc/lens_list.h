...
#define DW9800VAF_SetI2Cclient DW9800VAF_SetI2Cclient_Sub
#define DW9800VAF_Ioctl DW9800VAF_Ioctl_Sub
#define DW9800VAF_Release DW9800VAF_Release_Sub
#define DW9800VAF_GetFileName DW9800VAF_GetFileName_Sub
...
#define DW9800KAF_SetI2Cclient DW9800KAF_SetI2Cclient_Sub
#define DW9800KAF_Ioctl DW9800KAF_Ioctl_Sub
#define DW9800KAF_Release DW9800KAF_Release_Sub
#define DW9800KAF_GetFileName DW9800KAF_GetFileName_Sub
extern int DW9800KAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9800KAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9800KAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9800KAF_GetFileName(unsigned char *pFileName);
#endif
