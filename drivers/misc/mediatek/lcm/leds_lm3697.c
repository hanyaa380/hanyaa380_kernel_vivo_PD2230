...
/* vivo 72163315 add for support aw99703 */
struct lm3697_reg aw99703_regs[] = {
	{"AW99703_DEVICE_ID_REG",	AW99703_DEVICE_ID_REG},
	{"AW99703_SW_RESET_REG", 	AW99703_SW_RESET_REG},
	{"AW99703_MODE_REG",		AW99703_MODE_REG},
	{"AW99703_LEDCUR_REG",		AW99703_LEDCUR_REG},
	{"AW99703_BSTCTR1_REG",		AW99703_BSTCTR1_REG},
	{"AW99703_BSTCTR2_REG",		AW99703_BSTCTR2_REG},
	{"AW99703_LEDLSB_REG",		AW99703_LEDLSB_REG},
	{"AW99703_LEDMSB_REG",		AW99703_LEDMSB_REG},
	{"AW99703_PWM_REG", 		AW99703_PWM_REG},
	{"AW99703_TURNCFG_REG",		AW99703_TURNCFG_REG},
	{"AW99703_TRANCFG_REG",		AW99703_TRANCFG_REG},
	{"AW99703_FLASH_REG",		AW99703_FLASH_REG},
	{"AW99703_AFHIGH_REG",		AW99703_AFHIGH_REG},
	{"AW99703_AFLOW_REG",		AW99703_AFLOW_REG},
	{"AW99703_FLAGS1_REG",		AW99703_FLAGS1_REG},
	{"AW99703_FLAGS2_REG",		AW99703_FLAGS2_REG},
};
/* vivo 72163315 add for support aw99703 end */
...
static int lm3697_init_registers(void)
{
	...
	/* vivo 72163315 add for support aw99703 */
	else if (bl_hw_version == 0x2) {
		lm3697_write_bytes(AW99703_MODE_REG, 0x00);
		mdelay(1);
		lm3697_write_bytes(AW99703_LEDLSB_REG, 0x00);
		lm3697_write_bytes(AW99703_LEDMSB_REG, 0x00);
		lm3697_write_bytes(AW99703_BSTCTR1_REG, 0x2E);
		lm3697_write_bytes(AW99703_BSTCTR2_REG, 0xC0);
		lm3697_write_bytes(AW99703_PWM_REG, 0x93);
		lm3697_write_bytes(AW99703_TURNCFG_REG, 0x44);
		lm3697_write_bytes(AW99703_TRANCFG_REG, 0x41);
		temp_reg = 0x9F;
#ifdef CONFIG_VIVO_LCM_LM3697_LED_3_FEEDBACK
		temp_reg &= ~0x07;
		temp_reg |= 0x07;
		...
		temp_reg |= 0x98;
#endif
		lm3697_write_bytes(AW99703_LEDCUR_REG, temp_reg);
	}
	/* vivo 72163315 add for support aw99703 end */
	else {
...
enum led_brightness value)
{
	...
	if (value <= 0) {
		...
		/* vivo 72163315 add for support aw99703 */
			...
			lm3697_write_bytes (AW99703_LEDCUR_REG, 0x98);
			lm3697_write_bytes (AW99703_LEDLSB_REG, 0x00);
			lm3697_write_bytes (AW99703_LEDMSB_REG, 0x00);
		}
		/* vivo 72163315 add for support aw99703 end */
		...
		/* vivo 72163315 add for support aw99703 */
			...
			lm3697_write_bytes (AW99703_LEDLSB_REG, 0x00);
			lm3697_write_bytes (AW99703_LEDMSB_REG, value);
			lm3697_write_bytes (AW99703_MODE_REG, 0x01);
		}
		/* vivo 72163315 add for support aw99703 end */
		else {
			lm3697_write_bytes (0x04, 0x00);
...
#if defined(CONFIG_VIVO_I2C_BACKLIGHT_CUST_MODE_PD2281)
...
void lm3697_brightness_set(int value)
{
	...
	if (value <= 0) {
...
#if defined(CONFIG_VIVO_I2C_BACKLIGHT_CUST_MODE_PD2281)
		if (old_backlight_value == 0  || get_boot_mode_ex() == RECOVERY_BOOT || silent_backlight == 1)
#else
		if (old_backlight_value == 0  || get_boot_mode() == RECOVERY_BOOT || silent_backlight == 1)
#endif
			lm3697_init_registers();
		...
		/* vivo 72163315 add for support aw99703 */
			...
			lm3697_write_bytes (AW99703_LEDLSB_REG, backlight_lsb);
			lm3697_write_bytes (AW99703_LEDMSB_REG, backlight_msb);
			lm3697_write_bytes (AW99703_MODE_REG, 0x01);
		}
		/* vivo 72163315 add for support aw99703 end */
		else {
...
struct device_attribute *attr, char *buf)
{
	...
	/* vivo 72163315 add for support aw99703 */
		...
		reg_count = sizeof(aw99703_regs) / sizeof(aw99703_regs[0]);
		regs_p = aw99703_regs;
	}
	/* vivo 72163315 add for support aw99703 end */
	else {
