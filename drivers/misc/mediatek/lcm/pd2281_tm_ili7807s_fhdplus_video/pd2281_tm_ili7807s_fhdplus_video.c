...
#include "../../../../../vivo/system/display/vivosrc/fb/pd2281_tm_ili7807s_fhdplus_video_cmd.h"
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch_dyn = 34;
	params->dsi.horizontal_frontporch_dyn = 30;
	params->dsi.vertical_frontporch_dyn = 36;
...
static void lcm_init(void)
{
	...
	LCM_INFO("----pd2281 lcm_init----lcm mode = cmd mode :%d----\n", lcm_dsi_mode);
}
...
{
	if (lcm_software_id == 0x2E)
		return 0x10;
	else
		return 0xFF;
}

struct LCM_DRIVER pd2281_tm_ili7807s_fhdplus_dsi_vdo_lcm_drv = {
	.name = "pd2281_tm_ili7807s_fhdplus_dsi_vdo",
