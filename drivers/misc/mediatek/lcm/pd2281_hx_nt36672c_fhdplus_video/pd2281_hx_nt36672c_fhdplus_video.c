...
#include "../../../../../vivo/system/display/vivosrc/fb/pd2281_hx_nt36672c_fhdplus_video_cmd.h"
	...
	unsigned int count, unsigned char force_update)
{
	...
	for (i = 0; i < count; i++) {
		...
		default:
			dsi_set_cmdq_V22(cmdq, cmd, table[i].count-1, &table[i].para_list[1], force_update);
		}
	}
}
...
{
	if (lcm_software_id == 0x3C)
		return 0x81;
	else
		return 0xFF;
}

struct LCM_DRIVER pd2281_hx_nt36672c_fhdplus_dsi_vdo_lcm_drv = {
	.name = "pd2281_hx_nt36672c_fhdplus_vdo_drv",
