...
#ifdef CONFIG_VIVO_CHARGING_NEW_ARCH
static struct mt6358_gauge *this_gauge = NULL;
#endif
	...
	int threshold)
{
	...
	car = car * 1000;
	car = fg_div(car, gauge_dev->fg_cust_data->car_tune_value);
...
#ifdef CONFIG_VIVO_CHARGING_NEW_ARCH
static int mt6358_gauge_initial(struct meter_lib *ml)
{
	int ret = 0;
...
static int mt6358_gauge_reset(struct meter_lib *ml)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_zcv(struct meter_lib *ml, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_ocv(struct meter_lib *ml, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_current(struct meter_lib *ml, bool *is_charging, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_coulomb(struct meter_lib *ml, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_zcv_current(struct meter_lib *ml, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_sequence_current(struct meter_lib *ml, int interval_ms, int size, int *buf)
{
	int ret = 0, i = 0;
	signed int dvalue = 0;
	long long temp_value = 0;
...
static int mt6358_gauge_get_rtc_ui_soc(struct meter_lib *ml, int *data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_set_rtc_ui_soc(struct meter_lib *ml, int data)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_get_battery_plug_out_status(struct meter_lib *ml, int *plugout, int *plugout_time)
{
	int ret = 0;
	struct gauge_device *gauge_dev = (struct gauge_device *)(ml->private_data);
...
static int mt6358_gauge_register_interrupt_callback(struct meter_lib *ml, METER_CALLBACK callback)
{
	return -EINVAL;
}

static int mt6358_gauge_dump(struct meter_lib *ml)
{
	int ret = 0;
#if 1
	battery_dump_nag();
...
static int mt6358_gauge_get_version(struct meter_lib *ml)
{
	int ret = pmic_get_register_value(PMIC_HWCID);
	return ret;
}

static int mt6358_gauge_get_rm(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}

static int mt6358_gauge_get_fcc(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}

static int mt6358_gauge_get_soc(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}

static int mt6358_gauge_get_cycle(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}

static int mt6358_gauge_get_passedchg(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}

static int mt6358_gauge_get_cell_temperature(struct meter_lib *ml, int *data)
{
	return -EINVAL;
}
...
static struct meter_lib mtr_lib = {
	...
	.init = mt6358_gauge_initial,
	.reset = mt6358_gauge_reset,
	.get_zcv = mt6358_gauge_get_zcv,
	.get_ocv = mt6358_gauge_get_ocv,
	.get_the_current = mt6358_gauge_get_current,
	.get_coulomb = mt6358_gauge_get_coulomb,
	.get_zcv_current = mt6358_gauge_get_zcv_current,
	.get_sequence_current = mt6358_gauge_get_sequence_current,
	.get_rtc_ui_soc = mt6358_gauge_get_rtc_ui_soc,
	.set_rtc_ui_soc = mt6358_gauge_set_rtc_ui_soc,
	.get_battery_plug_out_status = mt6358_gauge_get_battery_plug_out_status,
	.register_interrupt_callback = mt6358_gauge_register_interrupt_callback,

	.dump = mt6358_gauge_dump,
	.get_version = mt6358_gauge_get_version,

	.get_rm = mt6358_gauge_get_rm,
	.get_fcc = mt6358_gauge_get_fcc,
	.get_soc = mt6358_gauge_get_soc,
	.get_cycle = mt6358_gauge_get_cycle,
	.get_passedchg = mt6358_gauge_get_passedchg,
	.get_cell_temperature = mt6358_gauge_get_cell_temperature,
};

static struct fuel_gauge_custom_data mt6358_gauge_cust_data = {
		...
		const struct gauge_properties *props)
{
	...
	gauge_dev->fg_cust_data = &mt6358_gauge_cust_data;
