...
#define SENSOR_TYPE_LCM_ESDCHECK                    98

/* end sensor type */
#define SENSOR_TYPE_MAX_NUM                            SENSOR_TYPE_LCM_ESDCHECK
...
#define ID_LCM_ESDCHECK  (ID_BASE + SENSOR_TYPE_LCM_ESDCHECK - 1)

/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE    (ID_LCM_ESDCHECK)
