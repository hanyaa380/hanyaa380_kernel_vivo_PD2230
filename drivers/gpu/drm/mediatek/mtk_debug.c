...
void set_mtk_debug_level(unsigned int level)
{
	static unsigned int level_bk;
	...
	if (level & 0x08)
		lcmpr_debug_enabled = 1;
	else
		lcmpr_debug_enabled = 0;
...
void disp_dbg_probe(void)
{
	...
	mtk_dp_debugfs_init();
#endif
	vdisp->panel_ops.set_debug_level = set_mtk_debug_level;
out:
	return;
}
