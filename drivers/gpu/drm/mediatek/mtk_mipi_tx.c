...
#if defined(CONFIG_DRM_PANEL_PD2279_TM_ILI7807S_FHDPLUS_VIDEO) || \
	defined(CONFIG_DRM_PANEL_PD2279_HX_NT36672C_FHDPLUS_VIDEO) || \
	defined(CONFIG_DRM_PANEL_PD2279_TM_ILI7807S_CPHY_FHDPLUS_VIDEO)

	//Lane2 and Lane3 swap
	writel(0x74523890, mipi_tx->regs + MIPITX_PHY_SEL0);
	writel(0x24223016, mipi_tx->regs + MIPITX_PHY_SEL1);
	writel(0x76543218, mipi_tx->regs + MIPITX_PHY_SEL2);
	writel(0x00000000, mipi_tx->regs + MIPITX_PHY_SEL3);
	//P and N swap
	writel(0x1, mipi_tx->regs + 0x140);
	writel(0x1, mipi_tx->regs + 0x240);
	writel(0x1, mipi_tx->regs + 0x340);
	writel(0x1, mipi_tx->regs + 0x440);
	writel(0x1, mipi_tx->regs + 0x540);
#endif
