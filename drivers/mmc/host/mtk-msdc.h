...
#define TUNE_FAIL_RETUNE   (0x1 << 4) /* transfer err for return flags */
#define TUNE_AUTOK_PASS    (0x1 << 5) /* autok pass flag */
...
struct msdc_host {
	...
	struct pinctrl_state *pins_uhs_samsung;
	struct pinctrl_state *pins_uhs_ymtc;
